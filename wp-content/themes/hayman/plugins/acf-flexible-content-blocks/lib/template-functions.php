 ...
 */
    ...
    function fcb_block_wrapper_classes() {
        ...
        $classes[]  = (get_sub_field('row_type')) ? get_sub_field('row_type') : '';
    ...
    function fcb_block_wrapper_styles() {
        ...
        $top_padding        = (get_sub_field('top_padding')) ? get_sub_field('top_padding') : '80';
        $bottom_padding     = (get_sub_field('bottom_padding')) ? get_sub_field('bottom_padding') : '80';
        $styles     = array();
